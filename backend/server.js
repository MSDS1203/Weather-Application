...
// URL: http://localhost:5000/citySearch?q=QUERY (replace QUERY with search query)
...
// URL: localhost:5000/zipSearch?q=QUERY (replace QUERY with zip and country code)
...
// URL: localhost:5000/weather?lat=LATITUDE&lon=LONGITUDE&unit=UNIT 
